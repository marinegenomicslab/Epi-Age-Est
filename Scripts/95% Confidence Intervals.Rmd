...
```{r}
#Both the "rsn_fulldata.csv" and "rdg_fulldata.csv" files can be used to run the following code to calculate 95% confidence intervals in red snapper and red grouper, respectively. The below code is scripted to run on the red snapper samples.

confintervals <- read.csv("rsn_fulldata.csv") #The first column inserted by default when reading in the .csv file ("X") may need to be removed before running the below script. In addition, the "Loc" column should be set as the rownames.
